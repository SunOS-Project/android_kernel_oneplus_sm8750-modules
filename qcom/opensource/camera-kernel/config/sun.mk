...
ccflags-y += -DCONFIG_SECURE_CAMERA_25=1
ccflags-y += -DCONFIG_SPECTRA_SECURE_CAMNOC_REG_UPDATE=1
ccflags-y += -DCONFIG_TARGET_SYNX_ENABLE=1
ccflags-y += -DCONFIG_INTERCONNECT_QCOM=1
ccflags-y += -DCONFIG_SPECTRA_OPLUS=1
ccflags-y += -DCONFIG_SPECTRA_SECURE_DYN_PORT_CFG=1
